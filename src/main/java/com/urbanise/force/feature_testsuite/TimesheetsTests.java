...
public class TimesheetsTests extends BaseTest
{
    ...
    {		
	   ...
	   swipeIfPopUpShows(); //Swipe left pop up shows once, so need to clear
       clickEntry(driver);
       ...
       clickNext(driver);       
       swipeIfPopUpShows(); //Swipe right pop up may appear so adding this here to clear    
	   ...
	   RegressionTests.checkInToAssignedJob(driver, _addTimeSheetPopOnCheckOut); // returning the driver back to joB time sheet to run the next test 
	   JobDetailPage.clickMoreTab(driver);
    }
    ...
    public static void addRateCard(AppiumDriver<MobileElement> driver)
    {
    	driver.findElementById("select_rate").click();    	
    	selectFirstRateCard(driver);
    }
    
    public static void selectFirstRateCard(AppiumDriver<MobileElement> driver)
    {
    ...
    public static void addAgentRateCard(AppiumDriver<MobileElement> driver)
    {
    	driver.findElementById("select_agent_rate").click();    	
    	selectFirstRateCard(driver);
    }
	...
	public void swipeIfPopUpShows() throws InterruptedException
    {
